...
if ramn_can_db:
    ...
    encode_funcs_8 = [
        ...
        "RAMN_Encode_Control_Shift",
        "RAMN_Encode_Joystick",
...
@pytest.mark.parametrize("signal_name, encode_func, decode_func, range_limit", [
    ...
    ("Control_Shift", ramn_can_db.RAMN_Encode_Control_Shift, ramn_can_db.RAMN_Decode_Control_Shift, 256),
    ("Joystick", ramn_can_db.RAMN_Encode_Joystick, ramn_can_db.RAMN_Decode_Joystick, 256),
